...
import { Home, List, BarChart3, Wallet, PlusCircle, Menu, X, Bell, PiggyBank, Target, Calendar, TrendingUp, Settings } from 'lucide-react'
  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-zinc-900 border-t border-gray-200 dark:border-zinc-800 z-40">
        ...
        {showMore && (
          <div className="grid grid-cols-3 gap-2 p-3 border-t border-gray-100 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-900/50">
            {moreItems.map(item => {
              const Icon = item.icon
